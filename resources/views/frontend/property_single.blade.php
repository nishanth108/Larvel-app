        ...
        <div class="portfolio-details-slider swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide">
              <img src="{{ asset('frontend/assets/img/property-slide/property-slide-1.jpg') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset('frontend/assets/img/property-slide/property-slide-2.jpg') }}" alt="">
            </div>

            <div class="swiper-slide">
              <img src="{{ asset('frontend/assets/img/property-slide/property-slide-3.jpg') }}" alt="">
            </div>
          ...
          <div class="col-lg-8" data-aos="fade-up">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade" id="real-estate-2-tab2">
                <img src="{{ asset('frontend/assets/img/floor-plan.jpg') }}" alt="" class="img-fluid">
