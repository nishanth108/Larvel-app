    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="{{ route('property') }}"  class="nav-link {{ request()->routeIs('property') ? 'active' : '' }}">Properties</a></li>
          <li><a href="{{ route('agent.page') }}"  class="nav-link {{ request()->routeIs('agent.page') ? 'active' : '' }}">Agents</a></li>
