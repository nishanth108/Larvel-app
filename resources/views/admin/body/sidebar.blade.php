<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
                    ...
                    <div class="collapse" id="emails">
                        <ul class="nav sub-menu">
                            ...
                            @if (Auth::user()->can('add.type'))
                                <li class="nav-item">
                                    <a href="{{ route('add.type') }}" class="nav-link">Add Types</a>
                                </li>
                            @endif
                        </ul>
                    </div>
            ...
            <li class="nav-item nav-category">Contact Management</li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.contact') }}" role="button">
